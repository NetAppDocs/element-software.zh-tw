...
.您需要的是 #8217 ；需要的是什麼
* 您已使用啟用軟體加密功能 link:../api/reference_element_api_createcluster.html["建立叢集"] 不含磁碟區且沒有I/O的新叢集上的方法使用 link:../api/reference_element_api_getsoftwareencryptionatrestinfo.html["「GetSoftwareEncryptionatRestInfo」"] 確認狀態為「已啟用」、然後再繼續。
