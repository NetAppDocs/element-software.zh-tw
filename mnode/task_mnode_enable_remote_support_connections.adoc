...
---
= 啟動遠端NetApp支援工作階段（Element 123及更早版本）
:allow-uri-read: 


[role="lead"]
如果您執行Element 123及更早版本、且SolidFire 需要支援您的整套Flash儲存系統、NetApp支援可遠端連線至您的系統。若要啟動工作階段並取得遠端存取、NetApp支援可開啟與環境的反轉安全Shell（SSH）連線。
