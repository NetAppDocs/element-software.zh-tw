...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP2885734["vCenter Plug-in 5.1 版本資訊"^] _新_
...
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.175.0.html["儲存裝置韌體套件 2.175.0 版本資訊"^] _新_
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.164.0.html["儲存韌體套裝組合2.164.0版本說明"^]
...
* https://docs.netapp.com/us-en/hci/docs/firmware_driver_versions.html["支援的韌體和ESXi驅動程式版本"] _新_
