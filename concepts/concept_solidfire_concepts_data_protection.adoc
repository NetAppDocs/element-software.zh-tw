...
如需詳細資訊，請參閱 https://www.netapp.com/pdf.html?item=/media/10607-tr4741.pdf["TR-4741：NetApp Element 《The》、《The》、《The》、《The》、《"^]。
...
請參閱 https://www.netapp.com/pdf.html?item=/media/19771-tr-4651.pdf["TR-4651：NetApp SolidFire SnapMirror架構與組態"^]
...
如需更多資訊、請參閱 link:../storage/element-replication-index.html["NetApp Element 軟體與 ONTAP 之間的複寫（ ONTAP CLI ）"]。
